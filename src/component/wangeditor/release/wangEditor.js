...
Image.prototype = {
    ...
    _createInsertPanel: function _createInsertPanel() {
        ...
        // tabs 的配置
      /** huangyaao 2017.12.5 修改上传可以上传所有文件  默认accept="image/jpg,image/jpeg,image/png,image/gif,image/bmp"/
       * 修改上传图片文字为上传文件
       * **/
        var tabsConfig = [{
            title: '上传文件',
...
UploadImg.prototype = {
    ...
    uploadImg: function uploadImg(files) {
        ...
        arrForEach(files, function (file) {
          ...
          maxSize
            /**huangyaao 2017.12.5 不再做后缀名和大小检查**/
...
Editor.prototype = {
    ...
    _initDom: function _initDom() {
        ...
        if (textSelector == null) {
            ...
            /** huangyaao 2017-12-4 修改整个editor的高度 默认是300 **/
            $textContainerElem.css('border', '1px solid #ccc').css('border-top', 'none').css('height', '200px');
        } else {
