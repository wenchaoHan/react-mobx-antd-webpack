...
var Upload = function (_React$Component) {
    ...
    function Upload(props) {
        ...
        _this.onSuccess = function (response, file) {
            ...
            var handlerResponse = _this.props.handlerResponse;

            if (handlerResponse) {
                var _handlerResponse = handlerResponse(response),
                    status = _handlerResponse.status;

                targetItem.status = status ? status : 'done';
            } else {
        ...
        _this.onSort = function (e) {
            var fileList = _this.state.fileList;
            var newIndex = e.newIndex,
                oldIndex = e.oldIndex;

            var tempFileList = fileList.concat();
            tempFileList.splice(oldIndex, 1);
            tempFileList.splice(newIndex, 0, fileList[oldIndex]);
            _this.setState({ fileList: tempFileList });
    ...
    Upload.prototype.render = function render() {
        ...
        var showRemoveIcon = showUploadList.showRemoveIcon,
            ...
            showDownIcon = showUploadList.showDownIcon;

        var uploadList = showUploadList ? _react2["default"].createElement(_UploadList2["default"], { sortable: sortable, listType: listType, items: this.state.fileList, onSort: this.onSort, onPreview: onPreview, onDown: onDown, onRemove: this.handleManualRemove, showRemoveIcon: showRemoveIcon, showDownIcon: showDownIcon, showPreviewIcon: showPreviewIcon, locale: this.getLocale() }) : null;
        if (type === 'drag') {
            var _classNames;
