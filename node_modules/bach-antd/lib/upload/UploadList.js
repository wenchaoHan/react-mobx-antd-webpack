...
var UploadList = function (_React$Component) {
    ...
    function UploadList() {
        ...
        _this.handleDown = function (file, e) {
            var onDown = _this.props.onDown;
    ...
    UploadList.prototype.componentDidMount = function componentDidMount() {
        if (this.props.listType === 'picture') {
            var sortable = this.props.sortable;

            if (sortable) {
                var el = document.getElementById('upload-picture-listitem-drag-sort');
    ...
    UploadList.prototype.render = function render() {
        ...
        var _props = this.props,
            ...
            showDownIcon = _props.showDownIcon,
        ...
        var list = items.map(function (file) {
            ...
            var downIcon = showDownIcon ? _react2["default"].createElement(
                'a',
                { href: file.url || file.thumbUrl, target: '_blank', rel: 'noopener noreferrer', style: style, onClick: function onClick(e) {
                        return _this3.handleDown(file, e);
                    } },
        ...
        var isPicture = listType === 'picture';
        var sortableCon = sortable && isPicture ? _react2["default"].createElement(
            'div',
            { id: 'upload-picture-listitem-drag-sort' },
            list
        ) : list;
        return _react2["default"].createElement(
            _rcAnimate2["default"],
