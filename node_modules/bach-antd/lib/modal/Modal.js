...
var Modal = function (_React$Component) {
    ...
    Modal.prototype.render = function render() {
        ...
        var defaultFooter = [_react2["default"].createElement(
            ...
            _button2["default"],
            { key: 'cancel', type: 'danger', size: 'large', onClick: this.handleCancel },
            cancelText || '取消'
        )];
        if (okRight) {
            defaultFooter = [_react2["default"].createElement(
                _button2["default"],
                { key: 'cancel', type: 'danger', size: 'large', onClick: this.handleCancel },
                cancelText || '取消'
            ), _react2["default"].createElement(
...
Modal.propTypes = {
    ...
    okRight: _propTypes2["default"].bool
};
Modal.contextTypes = {
