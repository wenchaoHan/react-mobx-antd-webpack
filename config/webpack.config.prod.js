...
// var viewsDir = path.resolve(path.appSrc, 'views');
console.log("---===views dir = ",paths.appSrcViews);
const files = glob.sync(paths.appSrcViews + '/*/index.js');
...
module.exports.entry = Object.assign({},module.exports.entry,entries());
